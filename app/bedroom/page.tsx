  ...
  return (
    <div className="w-full">
      ...
      <div className="relative w-full h-[30vh] sm:h-[35vh] lg:h-[40vh] bg-cover bg-center"
        style={{
          backgroundImage: "url('https://res.cloudinary.com/dloa5kpxd/image/upload/v1763732878/image_2_balhe9.jpg')"
        }}>
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4 sm:px-6">
          ...
          <p className="text-white/90 text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl">
            Create your perfect sanctuary with our bedroom furniture
          </p>
        </div>
      </div>
